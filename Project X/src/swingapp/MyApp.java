...
public class MyApp implements ActionListener, WindowListener ,MouseListener{
    ...
    JFrame frame;
    JLabel usernameLabel, passwordLabel,welcomeLabel,showLabel;
    ...
    public MyApp(){
        ...
        panel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(),BorderFactory.createLineBorder(Color.black, 3)));
        // frame.getContentPane().add(new JPanelWithBackground("bg.png"));
