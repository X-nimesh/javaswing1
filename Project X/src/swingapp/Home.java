...
public class Home  implements ActionListener,WindowListener, KeyListener {
    ...
    JButton upstdButton,saveButton, deleteButton, updateButton;
    ...
    public Home() {
        ...
        panel=new JPanel();
        panel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(),BorderFactory.createLineBorder(Color.cyan, 2)));
        panel.setBounds(20,70,450,600);
        ...
        scrollPane.setBounds(500,80,900,400);

        scrollPane.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);


        headingLabel=new JLabel("STUDENT DETAILS");
        headingLabel.setBounds(50,20,500,50);
        headingLabel.setFont(new Font("Cooper Black", Font.BOLD,30));

        firstNameLabel=new JLabel("First Name");
        firstNameLabel.setBounds(50,100,100,30);

        firstNameTextField=new JTextField();
        firstNameTextField.setBounds(150,100,200,30);
        ...
        genderLabel.setBounds(50,250,200,30);
        ...
        courseLabel.setBounds(50,300,100,30);
        ...
        comboCourse.setBounds(150,300,150,30);

        hobbieslLabel =new JLabel("Hobbies");
        hobbieslLabel.setBounds(50,350,100,30);

        programmingBox = new JCheckBox("Programming");
        playingBox = new JCheckBox("Playing Games");
        travellingBox= new JCheckBox("Travelling");
        programmingBox.setBounds(150,350,100,30);
        playingBox.setBounds(250,350,110,30);
        travellingBox.setBounds(360,350,100,30);

        phoneLabel =new JLabel("Phone");
        phoneLabel.setBounds(50,400,100,30);
        ...
        remarksLabel.setBounds(50,450,100,30);

        remaksArea = new JTextArea();
        remaksArea.setBounds(150,450,200,100); 

        upstdButton =new JButton("Update Student");
        upstdButton.setBounds(50,600,150,30);
        upstdButton.setActionCommand("updateStd");
        upstdButton.addActionListener(this);
        ...
        deleteButton.setBounds(500,500,100,30);
        deleteButton.setActionCommand("delete");
        deleteButton.addActionListener(this);

        updateButton =new JButton("Select");
        updateButton.setBounds(650,500,100,30);
            ...
            else if(e.getActionCommand().equals("delete"))
        {
            ...
            else if(e.getActionCommand().equals("update"))
            {
               saveButton.setActionCommand("updateStd");
                ...
                {
                    System.out.println("updtae button");
                    String firstName = firstNameTextField.getText();
                    String lastName = lastnameField.getText();
                    String address = addressField.getText();
                    String phone = phoneField.getText();
